...
import com.example.pokedex.feature.home.adapter.HomeAdapter
import com.example.pokedex.feature.home.adapter.PokemonLoadStateAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun initPokemonAdapter() {
        pokemonAdapter =
            HomeAdapter { pokemonResult: PokemonResult, view: View, dominantColor: Int, picture: String? ->
                val extras = FragmentNavigatorExtras(
                    view to pokemonResult.name
                )

                val directions = HomeFragmentDirections.actionHomeFragmentToPokemonDetailFragment(
